                ...
                <tbody>
                    ...
                    %>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="./BookServlet" method="get" class="d-inline">
                                    <input type="hidden" name="bookId" value="<%= book.getId() %>">
                                    <button type="submit" name="op" value="view_exemplaires" class="btn btn-outline-info">View Exemplaires</button>
                                </form>
                                <form action="./BookServlet" method="get" class="d-inline">
                                    <input type="hidden" name="bookId" value="<%= book.getId() %>">
                                    <button type="submit" name="op" value="delete" class="btn btn-outline-danger" <%= hasReservedExemplaire ? "disabled" : "" %>>Delete</button>
                                </form>
                            </td>
                        </tr>
                    <%
