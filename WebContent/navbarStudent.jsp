            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="StudentServlet?op=list_books">List Books</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="StudentServlet?op=reservations">My Reservations</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="login.jsp">
                                    <img src="./canvas.png" alt="Logout" class="logout-icon"> <!-- Update the path to your image -->
                                </a>
                            </li>
                        </ul>
                    </div>
